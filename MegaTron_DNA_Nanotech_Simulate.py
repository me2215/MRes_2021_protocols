...
if salt_conc < max(test_gradient):
    ...
    sys.exit()
    # 'print' and 'sys.exit()' commands for simlation only.
    # Use 'protocol.pause()' for real runs instead.
...
reservoir = protocol.load_labware('usascientific_12_reservoir_22ml', 5)
# Should be '4ti0131_12_reservoir_21000ul'; the 'USA scientific' definition is
# used for simlation purposes only.
